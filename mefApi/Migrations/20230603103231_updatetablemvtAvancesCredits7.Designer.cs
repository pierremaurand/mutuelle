...
namespace mefapi.Migrations
{
    ...
    [Migration("20230603103231_updatetablemvtAvancesCredits7")]
    partial class updatetablemvtAvancesCredits7
    {
            ...
            modelBuilder.Entity("mefApi.Models.EcheanceAvance", b =>
                {
                    ...
                    b.HasOne("mefApi.Models.Mouvement", "Mouvement")
                        .WithOne("EcheanceAvance")
                        .HasForeignKey("mefApi.Models.EcheanceAvance", "MouvementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
