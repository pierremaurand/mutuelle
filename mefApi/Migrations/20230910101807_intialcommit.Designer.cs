...
namespace mefapi.Migrations
{
    ...
    [Migration("20230910101807_intialcommit")]
            ...
            modelBuilder.Entity("mefApi.Models.Deboursement", b =>
                {
                    ...
                    b.HasOne("mefApi.Models.Mouvement", "Mouvement")
                        .WithOne("Deboursement")
                        .HasForeignKey("mefApi.Models.Deboursement", "MouvementId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
